...
<html lang="en">
    ...
    <body>
        ...
        <!-- Aqui tem q colocar o botão pra adicionar um caso -->
                            ...
                            <c:forEach items="${case}" var="case">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a  class="btn btn-primary" href="${pageContext.request.contextPath}/ong/editar/${case.id}"><i class="material-icons teal-text">Editar</i></a>
                                        <a  class="btn btn-primary" href="${pageContext.request.contextPath}/ong/remover/${case.id}"><i class="material-icons red-text">Deletar</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
